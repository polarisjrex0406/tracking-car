...
public class MotionHandler extends BasePositionHandler {
    ...
    public void handlePosition(Position position, Callback callback) {
        if (!position.hasAttribute(Position.KEY_MOTION)) {
            ...
            LogAction.logString(String.format("MotionValueNoAttribute:%b", position.getBoolean(Position.KEY_MOTION)));
        } else {
            LogAction.logString(String.format("MotionValueHasAttribute:%b", position.getBoolean(Position.KEY_MOTION)));
        }
